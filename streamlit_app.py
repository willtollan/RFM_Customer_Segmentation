...
# FIXED: Divides the raw tree output value by the total tree sum to guarantee a clean 0-1 probability range
predicted_class_prob = probabilities[predicted_class_int] / probabilities.sum()
